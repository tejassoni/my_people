...
class eyebrow_master extends Model
{
  ...
  /*
    * author : Tejas Soni
    * insert_data - insert records into table : eye_brow_master
  ...
  /*
    * author : Tejas Soni
    * list_all - get all table : eye_brow_master records    
    * @param  - None        
  ...
  /*
    * author : Tejas Soni
    * list_by_params - check dynamic where condition from controller table : eye_brow_master 
  ...
  /*
    * author : Tejas Soni
    * update_records - update records into table : eye_brow_master 
  ...
  /*
    * author : Tejas Soni
    * delete_bulk_records - Delete multiple : eye_brow_master 
  ...
  /*
    * author : Tejas Soni
    * deleteRecords - Delete ID : eye_brow_master 
    * @param  - ID
    * @return : boolean
    */
