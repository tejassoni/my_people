...
class lip_master extends Model
{
  /**
   ...
   * @var array
   */
  protected $fillable = ['lip_name', 'lip_color', 'lip_description', 'lip_img', 'status'];
  ...
  /*
    * author : Tejas Soni
    * insert_data - insert records into table : lip_master
  ...
  /*
    * author : Tejas Soni
    * list_all - get all table : lip_master records    
    * @param  - None        
  ...
  /*
    * author : Tejas Soni
    * list_by_params - check dynamic where condition from controller table : lip_master 
  ...
  /*
    * author : Tejas Soni
    * update_records - update records into table : lip_master 
    * @param  - Update Array, ID to update
    * @return : boolean
    */
  public function update_records($udpate_data = array(), $where_check)
  {
    return self::where('lip_id', $where_check)->update($udpate_data);
  }

  /*
    * author : Tejas Soni
    * delete_bulk_records - Delete multiple : lip_master 
    * @param  - IDs Array [1,34,5]
    * @return : boolean
    */
  public function delete_bulk_records($delete_ids = array())
  {
    return self::whereIn('lip_id', $delete_ids)->delete();
  }
  ...
  /*
    * author : Tejas Soni
    * deleteRecords - Delete ID : lip_master 
    * @param  - ID
    * @return : boolean
    */
  public function deleteRecords($delete_id = "")
  {
    return self::where('lip_id', $delete_id)->delete();
  }
  ...
  {
    $data = self::select('*')->where('lip_id', $id)->get();
    if (!empty($data)) {
      $data = $data->toArray();
    }
    return $data;
