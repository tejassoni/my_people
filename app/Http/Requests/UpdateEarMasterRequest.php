...
class UpdateEarMasterRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        if (self::hasFile('filename')) {
            return [ // New File upload is uploaded, File name will be update database
                'ear_name' => 'required',
                'ear_color' => 'required',
                'filename' => 'required|mimes:jpeg,jpg,bmp,png|min:1|max:5120', // file type : jpeg,jpg,bmp,png, min size : 24kb , max size : 5 mb 1024*5 = 5120
            ];
    ...
    {
        return [
            'ear_name.required' => 'Name field is required..!',
            'ear_color.required' => 'Color field is required..!',
