          ...
          <form role="form" name="skin_edit" id="skin_edit" method="post" action="{{ url('admin/skin_update',[$skin_result->skin_id]) }}" enctype="multipart/form-data">
            ...
            <div class="card-body">
              ...
              <div class="form-group custom-file mb-3">
                ...
                <!-- File preview Starts -->
                <img class="file_preview mb-5 {{ (!empty($skin_result->skin_img))? '' : 'd-none' }}" id="img_view" src="{{ (is_array(old()) && !empty(old('skin_img')))? old('skin_img') : $skin_result->skin_img }}" height="70" width="70">
