          ...
          <form role="form" name="hair_edit" id="hair_edit" method="post" action="{{ url('admin/hair_update',[$hair_result->hair_id]) }}" enctype="multipart/form-data">
            ...
            <div class="card-body">
              ...
              <div class="form-group custom-file mb-3">
                ...
                <!-- File preview Starts -->
                <img class="file_preview mb-5 {{ (!empty($hair_result->hair_img))? '' : 'd-none' }}" id="img_view" src="{{ (is_array(old()) && !empty(old('hair_img')))? old('hair_img') : $hair_result->hair_img }}" height="70" width="70">
