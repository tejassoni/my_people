          ...
          <form ear="form" name="eyebrow_add" id="eyebrow_add" method="post" action="{{ url('admin/eyebrow_insert') }}" enctype="multipart/form-data">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="eye_brow_name" id="eye_brow_name" placeholder="Enter Eyebrow Name" value="{{ old('eye_brow_name') }}">
              </div>
              <div class="form-group">
                <label for="eye_brow_color"><?= ('Color') ?></label>
                <input type="text" class="form-control" name="eye_brow_color" id="eye_brow_color" placeholder="Select Eyebrow Color" value="{{ old('eye_brow_color') }}" />
              </div>
