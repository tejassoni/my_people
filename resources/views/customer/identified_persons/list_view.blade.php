  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <!-- /.card-header -->
        <div class="card-body">
          <table id="identified_person_list_table" class="display datatables table table-striped table-bordered w-100">
            <thead>
              <tr>
                <th><?= ('Name') ?></th>
                <th><?= ('Image') ?></th>
...
<script src="{{ asset('js/customer/identified_people.js') }}" defer></script>
@stop