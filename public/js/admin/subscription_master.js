            ...
            success: function(data, textStatus, jqXHR) {
                if (data.status) {
                    ...
                    warning_head +=
                        '<i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Sorry, Operation Fails...!';
                    warning_body +=
                        "Subscriptions are not deleted... Please try after sometime. ";
                    $(".modal-header h4").html(warning_head);
                    $(".modal-body p").html(warning_body);
                    $(".error_modal").trigger("click");
                    setTimeout(function() {
            ...
            success: function(data, textStatus, jqXHR) {
                if (data.status) {
                    ...
                    warning_head +=
                        '<i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Sorry, Operation Fails...!';
                    warning_body +=
                        "Subscription is not deleted... Please try after sometime. ";
                    $(".modal-header h4").html(warning_head);
                    $(".modal-body p").html(warning_body);
                    $(".error_modal").trigger("click");
                    setTimeout(function() {
            ...
            success: function(data, textStatus, jqXHR) {
                if (data.status) {
                    ...
                    warning_head +=
                        '<i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Sorry, Operation Fails...!';
                    warning_body +=
                        "Subscription is In Activated... Please try after sometime. ";
                    $(".modal-header h4").html(warning_head);
                    $(".modal-body p").html(warning_body);
                    $(".error_modal").trigger("click");
                    setTimeout(function() {
