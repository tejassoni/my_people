$(document).ready(function() {
    ...
    $("#plan_list_table").DataTable({
        ...
        aLengthMenu: [
            ...
            [10, 25, 5, 60, 100, 200, -1],
            [10, 25, 5, 60, 100, 200, "All"]
        ],
            ...
            success: function(data, textStatus, jqXHR) {
                if (data.status) {
                    ...
                    warning_head +=
                        '<i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Sorry, Operation Fails...!';
                    warning_body +=
                        "Plans are not deleted... Please try after sometime. ";
                    $(".modal-header h4").html(warning_head);
                    $(".modal-body p").html(warning_body);
                    $(".error_modal").trigger("click");
                    setTimeout(function() {
            ...
            success: function(data, textStatus, jqXHR) {
                if (data.status) {
                    ...
                    warning_head +=
                        '<i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Sorry, Operation Fails...!';
                    warning_body +=
                        "Plan is not deleted... Please try after sometime. ";
                    $(".modal-header h4").html(warning_head);
                    $(".modal-body p").html(warning_body);
                    $(".error_modal").trigger("click");
                    setTimeout(function() {
            ...
            success: function(data, textStatus, jqXHR) {
                if (data.status) {
                    ...
                    warning_head +=
                        '<i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Sorry, Operation Fails...!';
                    warning_body +=
                        "Plan is In Activated... Please try after sometime. ";
                    $(".modal-header h4").html(warning_head);
                    $(".modal-body p").html(warning_body);
                    $(".error_modal").trigger("click");
                    setTimeout(function() {
